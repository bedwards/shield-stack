...
export const metadata: Metadata = {
  title: "RecallRadar - Product Recall Barcode Scanner for Parents",
  description:
    "Scan any product barcode to instantly check if it has been recalled by the CPSC. Build a product inventory and receive push alerts for future recalls.",
  keywords: [
    "product recall check",
    "is my product recalled",
    "CPSC recall lookup",
    "barcode scanner recall",
    "baby product recall",
    "toy recall checker",
          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-[var(--muted)]">
                &copy; {new Date().getFullYear()} RecallRadar. All rights
                reserved.
              </p>
