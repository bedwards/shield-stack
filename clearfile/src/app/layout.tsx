...
export const metadata: Metadata = {
  title: "ClearFile - Background Check Error Dispute Tool",
  description:
    "Discover errors in your background check, generate FCRA-compliant dispute letters, and track corrections across all major consumer reporting agencies.",
  keywords: [
    "background check wrong information",
    "how to dispute background check",
    "background check error",
    "FCRA dispute letter",
    "background check shows someone else record",
          ...
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-[var(--muted)]">
                &copy; {new Date().getFullYear()} ClearFile. All rights
                reserved.
              </p>
