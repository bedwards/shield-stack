...
export const metadata: Metadata = {
  title: "FAFSAcopilot - Real-Time FAFSA Error Catcher & Aid Negotiator",
  description:
    "Catch FAFSA mistakes before they cost you thousands. Get real-time error detection, aid package comparison, and negotiation letter templates.",
  keywords: [
    "FAFSA help",
          ...
          <nav data-testid="nav" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <Link href="/" data-testid="logo-link" className="text-xl font-bold text-[var(--primary)]">FAFSAcopilot</Link>
              </div>
              <div className="flex items-center gap-4">
                <Link href="/check" data-testid="nav-check" className="text-sm text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">Error Checker</Link>
                <Link href="/compare" data-testid="nav-compare" className="text-sm text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">Compare Aid</Link>
        ...
        <footer data-testid="footer" className="border-t border-[var(--border)] bg-[var(--background)]">
          <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-[var(--muted)]">&copy; {new Date().getFullYear()} FAFSAcopilot. All rights reserved.</p>
